...
const workspaceTabs = [
  ...
  },
  {
    ...
    accent: 'border-violet-200 bg-[linear-gradient(135deg,rgba(245,243,255,0.82),rgba(240,249,255,0.9))] hover:border-violet-300',
      ...
      <section className="mx-auto w-full max-w-5xl">
        <div className="mb-5 text-center">
          ...
          <p className="mt-2 text-sm text-slate-600">
            아래 두 방식 중 하나를 선택하면 각각 수동 배포 화면 또는 자동 배포 화면으로 바로 이동합니다.
          </p>
        </div>
            ...
            >
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <h3 className={`mt-4 text-2xl font-semibold ${tab.titleTone}`}>{tab.title}</h3>
