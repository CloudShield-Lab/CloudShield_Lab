...
- 평균 응답시간: ${session.metrics.secure.avgLatency}ms
...
## 4. 핵심 인사이트
두 환경 비교를 통한 주요 보안 교훈과 실제 운영 환경에 적용할 권고사항을 제시하세요.`,
    };
  }
...
- Avg response time: ${session.metrics.secure.avgLatency}ms

Please analyze using the following 4 sections:
...
## 4. Key Insights
Provide major security lessons from comparing both environments and actionable recommendations for production environments.`,
  };
}
